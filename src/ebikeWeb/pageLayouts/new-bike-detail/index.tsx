...
//                       <Grid item xs={isMobile ? 12 : 8.9} className={styles.bike_information_grid1}>
...
//                       <Grid item xs={isMobile ? 0 : 3} className={styles.bike_information_grid2}>
//                         {
//                           allDealerArr.length > 0 ?
//                             <> <Typography className={styles.heading}>Dealers</Typography>
//                               <Box className={styles.Dealers_card}>
...
//                           <Grid item xs={isMobile ? 12 : 8.9} className={styles.bike_video_box}>
//                             <Box className={styles.bike_video}>
//                               <iframe
//                                 src={embebedYoutubeVideoId(e?.bike?.videoUrl)}
//                                 title="YouTube video player"
