...
//         return (
//             <List sx={{ width: '100%', padding: '0px', margin: '0px', backgroundColor: 'whitesmoke', color: 'black' }}>
...
//                 {options.map((e, index) => (
//                     <Collapse key={index} in={isOpen} timeout="auto" unmountOnExit>
//                         <Link href={`/ebike-panel/dashboard/${urls[index]}`} sx={{ textDecoration: 'none', color: 'black' }}>
//                             <List component="div" disablePadding>
...
//             </div>
//             <div className={styles.list}>
//                 <List component="div" disablePadding sx={{ backgroundColor: 'whitesmoke', color: 'black' }}>
