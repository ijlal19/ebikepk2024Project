...
import { CancelOrderPending, GetAllOrders } from "@/ebike-panel/ebike-panel-Function/globalfunction";
...
const PendingOrders = () => {
    ...
    const handleCancel = async (orderId: any, id: any) => {
        ...
        const res = await CancelOrderPending(orderId, id, payload)
        if (res && res?.success) {
            fetchAllOrders(1)
        }
        else {
                                                ...
                                                return (
                                                    <div className={styles.card_main} key={i} >
                                                        ...
                                                        <div className={styles.action}>
                                                            <button className={styles.btn} style={{ background: "#3498db" }} >Process Order</button>
