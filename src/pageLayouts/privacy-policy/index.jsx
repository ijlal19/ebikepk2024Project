...
Ebike.pk collect your Information solely for the purpose of providing you the products or services that is connected with the function or activity of the ebike.pk which includes but not limited to the following (“Purpose”):
<br /><br />

To inform you about various products and services offered on our platform and provide customer support to You.<br />
To address your queries and resolve your concerns pertaining to any product or service that You were looking for.<br />
To send you survey and marketing communications or facilitate various programs and initiatives launched either by us or third parties which we believe may be of interest to you.<br />
To facilitate your usage of the platform (what features you like, how you use them etc.) and improve our products or services, or any other content on the platform (such as by personalizing content to your interests), process and complete your transactions, and make special offers.<br />
To review platform performance, diagnose technical problems and do data analysis to make your experience better.<br />
To protect the integrity of our platform.<br />
To inform you about change in any term and condition of this Privacy Policy or Terms of Use of any platform of ebike.pk
To implement information security practices, to determine any security breaches, contaminant or computer virus, to investigate/prevent/take action against illegal activities and suspected fraud.<br />
To keep you informed about news, events and ideas regarding your preferences and help you to improve your knowledge and skills about the preferred content.<br />
To carry out our obligations and enforce our rights arising from any contracts entered into between you and us.<br />
To allow you to participate in interactive features offered through our Platform.<br />
...
Users may opt-out of receiving future mailings from us and other entities by following the instructions set forth in the opt-out section below.
<br /><br />

We may disclose your personal data to law enforcement authorities, regulators, governmental or public bodies and other relevant third parties to comply with any legal or regulatory requirements.
<br /><br />

In addition to this, ebike.pk reserve the right to share your information with any government agency or other authorized law enforcement agencies mandated under law to obtain your information for the purpose of verification of identity or for prevention, detection, investigation including but not limited to cyber incidents, prosecution, and punishment of offences etc.
<br /><br />

We may process your Information outside Pakistan on legally provided mechanisms to lawfully transfer your Information across borders. 
<br /><br />
...
You may have certain legal rights regarding your personal data. you will have the following rights regarding data subjects in Pakistan.
<br /><br />

<br /><br />
If you choose to close your account, we will delete your personal information or de-identify it so that it is anonymous and not attributed to your identity. We will retain your personal information after you have closed your account if reasonably necessary to comply with our legal obligations (including law enforcement requests), meet regulatory requirements, resolve disputes, maintain security, prevent fraud and abuse, enforce our user agreement, or fulfill your request to “unsubscribe” from further messages from us. We will retain de-personalized information after your account has been closed. <br /><br />
You can ask us for a copy of Your personal information.
Right to request access to your personal data (commonly known as a “data subject access request”). This enables you to receive a copy of the personal data we hold about you and to check that we are lawfully processing it.<br /><br />
Right to request correction, change, update or modify information previously provided. This enables you to have any incomplete or inaccurate data we hold about you corrected, though we may need to verify the accuracy of the new data you provide to us.
Right to withdraw your consent to the processing of your personal data at any time. This does not affect the legality of any processing we have already carried out based on the consent given previously.<br /><br />
You can request to delete your Data. This enables you to ask us to delete or remove Personal Data where there is no good reason for us continuing to process it. You also have the right to ask us to delete or remove your Personal Data where you have exercised your right to object to processing
If you wish to submit a data rights request to access, correct, delete, export, rectify, update, or ask questions about your personal data, you may do so via our Contact Us Page <br /><br />
Once we receive and confirm your verifiable consumer request, we will (and will direct our service providers to whom we have disclosed your Personal Data to) delete your Personal Data. These rights do not apply to Personal Data collected from ebike.pk’s employees as part of their employment with ebike.pk or Personal Data collected as part of a business-to-business transaction. To exercise any of the rights set out above, please contact the ebike.pk team using the Contact Us Page Only you, or someone legally authorised to act on your behalf, may make a verifiable consumer request related to your Personal Data. we may need to request specific information from you to help us confirm that your request is a verifiable consumer request.
<br /><br />
...
It is clarified that force majeure events includes any event which is beyond the reasonable control of the ebike.pk which may include but not limited to sabotage, fire, flood, explosion, acts of God, civil commotion, strikes or industrial action of any kind, riots, insurrection, war, acts of government, computer hacking, unauthorized access to computer, computer system or computer network, computer crashes, breach of security and encryption.
<br /><br />

Our website contains links to other websites. Our mobile application may also contain links to other mobile applications and websites. If you click on one of these links, please note that each one will have its own privacy policy. We do not control these websites/apps and ebike.pk is not responsible for the privacy practices or the content of such websites and mobile applications. We are not responsible for the direct or indirect consequences of you linking to any other website from this website. When you leave our platform, we encourage you to read the privacy notice of every website you visit.
<br /><br />

Ebike.pk also has a forum. Please remember that any information that is disclosed in these areas becomes public information and you should exercise caution when deciding to disclose your personal information.
<br /><br />

Ebike.pk reserves the right to amend or modify this privacy policy at any time, as and when the need arises. We request you to keep it up to date with legal requirements and the way we operate our business. Please regularly check this privacy policy from time to time to keep you apprised of changes made/latest version of this privacy policy. Your continued use of the Platform gives your unconditional acceptance to such change in terms of Privacy Policy.
<br /><br />
